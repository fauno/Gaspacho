...
//	descripcion = descripcion.replace(/[^a-zA-Z0-9,.]/,"").substr(0,300);

	salida  = '<li class="row">';
	salida += '	<div class="span8 thumbnail">';
	salida += '		<h3><i class="icon-' + tipo + '"></i>' + titulo + '</h3>';
	salida += '		<div class="span2" ">';
	salida += '			<a href="'+ enlace +'" >';
	if (medio) salida += '				<img src="' + medio + '" class="img-polaroid" />';
	salida += '			</a>';
	salida += '		</div>';
	salida += '		<div class="span5">';
